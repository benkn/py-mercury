...
def decorateTransaction(transaction):
    ...
    if transaction.personal_finance_category != None:
        primary = transaction.personal_finance_category.primary.trim()
        detailed = transaction.personal_finance_category.detailed.trim()
        subCategory = detailed.substring(primary.length)
